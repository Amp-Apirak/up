                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                                    ...
                                    $_sql_service_cate = "SELECT DISTINCT service  FROM work ";
                                    $_sql_service_type = "SELECT DISTINCT category  FROM work ";
                                    $_sql_service_sup = "SELECT DISTINCT items   FROM work ";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <div class="small-box bg-warning">
                                            ...
                                            <!-- Qeury Count All Service -->
                                            <?php 
                                                                $query2 = "SELECT DISTINCT COUNT(`work_id`) as AMP FROM work  WHERE `status` = 'On Process' AND ";
