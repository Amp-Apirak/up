...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2023 at 03:13 AM
...
(57, 'Uplevel Application', 'Incident', 'Dev Test', 'Register', 'Application Respone', 'On Process', 'การ Login เข้าใช้งาน App ในครั้งแรกบางครั้งมีการเด้งไปที่หน้าสร้างทีม โดยไม่ผ่านหน้า Register', 'ถ้าเข้าไปแล้วระบบไปที่หน้าสร้างทีมเลยจะเกิดปัญหาตามภาพที่แนบคะ แต่ถ้าระบบไปที่หน้า Register หน้าสีน้ำเงินจะสามารถเข้าใช้งาน application ได้ปกติคะ ', 'คุณยุทธนา (พี่ตำรวจ)', '2023-11-08 07:59:57', 'คุณภัทราอร (ซีน)', '2023-11-08 07:59:57', 'คุณภัทราอร (ซีน)', '1226.jpg', '', 'เปลี่ยนหัวข้อเรื่องใหม่'),
(58, 'Uplevel Application', 'Incident', 'Dev Test', 'Dashboard\r\n', 'Edit/Update\r\n', 'On Process', 'รบกวนแก้ไขหน้า Team Dashboard โดยให้ยังคงมี () และตัวเลขของสมาชิกในทีม', 'รบกวนแก้ไขหน้า Team Dashboard โดยให้ยังคงมี () และตัวเลขของสมาชิกในทีม แบบเดิม หลังชื่อทีม อาทิเช่น Health Food (2)', 'คุณยุทธนา (พี่ตำรวจ)', '2023-11-08 05:31:44', 'คุณภัทราอร (ซีน)', '2023-11-08 05:31:44', '', 'Team.jpg', '', ''),
(59, 'Uplevel Application', 'Incident', 'Dev Test', 'Add Team member(s)', 'Edit/Update', 'On Process', 'แก้ไขหน้าการแสดงผลหลังจากที่มีการ Invite เข้าทีม', 'ในกรณีที่เรา Scan QR cord เข้าร่วมทีม ที่เพื่อนเชิญมา ระบบควรแสดงไปยังหน้าทีมที่เพื่อเชิญให้เราเข้าร่วมทีม ไม่ควรเป็นหน้าทีมที่เราเข้าค้างไว้จากครั้งก่อนคะ \r\nตรงกับที่ทางพี่เหน่งขอมาคะ *และเมื่อ scan แล้ว ผมอยากให้ app ของคนที่ scan มันวิ่งไปที่หน้าหลักของ ทีมๆที่เพิ่ง scan เลยตอนนี้ ที่ผมลองดู ด้วยอีกเครื่องนึง แม้จะเข้าเป็นสมาชิกเรียบร้อยแล้ว แต่หน้าใน App ที่เปิดยังเป็นหน้าทีมเดิมที่ใช้งานอยู่ เลยไม่รู้ว่า add เข้ามาสำเร็จมั้ยจนกว่าจะถอยออกมาก่อน*', 'คุณยุทธนา (พี่ตำรวจ)', '2023-11-08 05:31:40', 'คุณภัทราอร (ซีน)', '2023-11-08 05:31:40', 'คุณภัทราอร (ซีน)', '', '', ''),
(60, '๊Uplevel Application', 'Incident', 'Dev Test', 'Add Team member(s)', 'Edit/Update\r\n', 'On Process', 'แก้ไข text ของ QR code ที่ใช้ add team member', 'ขอให้ทำการแก้ไข text ของ QR code ที่ใช้ add team member แก้ไขเป็น  \r\nAdd Team members\r\nGet them to scan this before 08:17:11 (within 3 minutes)', 'คุณสุรพันธ์ (พี่ขวัญ)', '2023-11-08 05:32:19', 'คุณภัทราอร (ซีน)', '2023-11-08 05:32:19', '', 'Add member.jpg', '', ''),
(61, 'Uplevel Application', 'Incident', 'Dev Test', 'Share Uplevel to others', 'Edit/Update\r\n', 'On Process', 'แก้ไข taxt QR code ที่ใช้ share uplevel ', 'แก้ไข taxt QR code ที่ใช้ share uplevel ให้คนอื่น (บอกต่อให้เพื่อนใช้) ควรเปลี่ยน text เป็น\r\nScan QR code to install Uplevel App to Line account. \r\nCap screen for sharing, or\r\nและมีปุ่ม \r\nsend link to Line \r\nอยู่ด้านล่าง', 'คุณสุรพันธ์ (พี่ขวัญ)', '2023-11-08 05:36:51', 'คุณภัทราอร (ซีน)', '2023-11-08 05:36:51', '', 'Share App.jpg', '', ''),
(62, 'Uplevel Application', 'Incident', 'Dev Test', 'My Profile setting', 'Application Respone', 'On Process', 'ระบบไม่ดึง Display name ใน Line มาแสดง', 'หลังจากที่มีการ Register เข้าใช้งานระบบ ปรากฎว่าระบบไม่ดึงชื่อ Display name ที่เราตั้งไว้ในระบบ Line มาให้ ซึ่งก่อนหน้านี้ระบบจะดึงมาให้คะ ตอนนี้ระบบโชว์เป็นสัญลักษณ์แทนคะ ตามรูปแนบ', 'คุณยุทธนา (พี่ตำรวจ)', '2023-11-08 05:44:17', 'คุณภัทราอร (ซีน)', '2023-11-08 05:44:17', '', 'S__114024450.jpg', '', ''),
(63, 'Uplevel Application', 'Incident', 'Dev Test', 'My Profile setting', 'Application Respone', 'On Process', 'ระบบไม่จำชื่อ Profile ที่เราแก้ไข', 'เมื่อทำการแก้ไขชื่อที่ edit profile กดบันทึกเรียบร้อยแล้ว ระบบแสดงชื่อที่ได้มีการแก้ไขใหม่ แต่หลังจากที่ออกจากระบบและเข้าใช้ระบบใหม่อีกครั้งปรากฎว่าระบบกลับแสดงชื่อเดิมที่ได้มีการเปลี่ยนหรือแก้ไขไปแล้ว ตามรูปแบบ', 'คุณยุทธนา (พี่ตำรวจ)', '2023-11-08 05:51:56', 'คุณภัทราอร (ซีน)', '2023-11-08 05:51:56', '', 'Display name.png', '', '');
