...
<head>
    ...
    <title>INO | Update Custormer</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Update Custormer</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Update Custormer</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
<?php
  ...
  $rs = $conn->query("SELECT * FROM tb_contact WHERE contact_id=" . $_GET['id']);
...
if (isset($_POST['submit'])) { /* ถ้า POST มีการกด Submit ให้ทำส่วนล่าง */
    ...
    $sql =  "UPDATE `tb_contact` SET `contact_group` = '$contact_group', `contact_name` = '$contact_name', `contact_position` = '$contact_position', 
    `contact_phone` = '$contact_phone', `contact_email` = '$contact_email', `contact_company` = '$contact_company', `contact_address` = '$contact_address', 
    `contact_date` = '$contact_date', `contact_team` = '$contact_team' WHERE contact_id=" . $_GET['id'];
                                    ...
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="contact_group" required
                                                style="width: 100%;">
                                                <option selected="selected"><?= $r->contact_group; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="contact_address" id="contact_address" rows="5"
                                                placeholder="รายละเอีดยที่อยู่บริษัท(ถ้ามี)....."><?= $r->	contact_address; ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                <label>ทีม</label>
                                                <select class="form-control select2" name="contact_team" value="<?= $r->contact_team; ?>"
                                                    style="width: 100%;" >
                                                    <option selected="selected"><?= $r->contact_team; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate"
                                                ...
                                                <input type="text" value="<?= $r->contact_date; ?>"  name="contact_date" 
